...
<body class="body"
	style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#001736; -webkit-text-size-adjust:none;">
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="img m-center"
																...
																<img src="images/mail_template/logo.jpg" width="131" height="38"
																	border="0" alt="" />
															</td>
														</tr>
													</table>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="text-header"
																style="color:#475c77; font-family:'Muli', Arial,sans-serif; font-size:12px; line-height:16px; text-align:right;">
																<a href="http://www.vtasl.gov.lk" target="_blank"
																	class="link2"
																	style="color:#475c77; text-decoration:none;"><span
																		class="link2"
																		style="color:#475c77; text-decoration:none;">Vocational
																		Training Authority</span></a>
															</td>
														</tr>
													</table>
												</th>
											...
											<tr>
												<td class="fluid-img"
													style="font-size:0pt; line-height:0pt; text-align:left;"><img
														src="image/mail_template/image1.jpg" width="650" height="366" border="0"
														alt="" /></td>
											</tr>
											<tr>
												<td class="p30-15" style="padding: 50px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h3 pb20"
																style="color:#ffffff; font-family:'Muli', Arial,sans-serif; font-size:25px; line-height:32px; text-align:left; padding-bottom:20px;">
																...
																<table border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="blue-button text-button"
																			style="background:#66c7ff; color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:14px; line-height:18px; padding:12px 30px; text-align:center; border-radius:0px 22px 22px 22px; font-weight:bold;">
																			<span target="_blank"
																				class="link-white"
																				style="color:#ffffff; text-decoration:none;"><span
																					class="link-white"
																					style="color:#ffffff; text-decoration:none;">Verification Code : ${data.v_code}</span></span>
																		</td>
																	</tr>
																</table>
															</td>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td class="img" width="55"
																...
																<a href="#" target="_blank"><img
																		src="image/mail_template/ico_facebook.jpg" width="38"
																		height="38" border="0" alt="" /></a>
															</td>
															<td class="img" width="55"
																style="font-size:0pt; line-height:0pt; text-align:left;">
																<a href="#" target="_blank"><img
																		src="image/mail_template/ico_twitter.jpg" width="38"
																		height="38" border="0" alt="" /></a>
															</td>
															<td class="img" width="55"
																style="font-size:0pt; line-height:0pt; text-align:left;">
																<a href="#" target="_blank"><img
																		src="image/mail_template/ico_instagram.jpg" width="38"
																		height="38" border="0" alt="" /></a>
															</td>
															<td class="img" width="38"
																style="font-size:0pt; line-height:0pt; text-align:left;">
																<a href="#" target="_blank"><img
																		src="image/mail_template/ico_linkedin.jpg" width="38"
																		height="38" border="0" alt="" /></a>
															</td>
														</tr>
													</table>
											...
											<tr>
												<td class="text-footer1 pb10"
													...
													Bussy - Free HTML Email Template</td>
											</tr>
											<tr>
												<td class="text-footer2"
													...
													East Pixel Bld. 99, Creative City 9000, <br />Republic of Design
												</td>
											</tr>
										</table>
									</td>
